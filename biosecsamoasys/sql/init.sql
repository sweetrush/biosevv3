...
CREATE TABLE IF NOT EXISTS voyage_details (
    ...
    PortOfLoadingID VARCHAR(255),
    LastPortID VARCHAR(255),
    PortOfArrivalID VARCHAR(255),
    LocationID VARCHAR(255),
    ArrivalDate VARCHAR(255),
    Pax VARCHAR(255),
    Crew VARCHAR(255),
    CrewSearched VARCHAR(255),
    TotalDischarged VARCHAR(255),
    VesselID VARCHAR(255),
    RoomSealed VARCHAR(255),
    AirOfSea VARCHAR(255),
    NoXRated VARCHAR(255),
    BondedAnimals VARCHAR(255),
    BondedAnimalsDescription TEXT,
    AnimalHealthCertificate VARCHAR(255),
    NumberContainers VARCHAR(255),
    NumberCargosDischarged VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS passenger_inspection (
    ...
    CommodityTypeID INT,
    LocationID VARCHAR(255),
    NoOfConsignments VARCHAR(255),
    NoOfNonCompliant VARCHAR(255),
    ModifiedBy VARCHAR(255),
    ModifiedDate VARCHAR(255),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
