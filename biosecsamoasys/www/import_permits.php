...
$pageTitle = 'Import Permits - Samoa Biosecurity System';
$currentPage = 'import_permits';
...
<?php include 'includes/layout-start.php'; ?>
                ...
                <div id="permitModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
...
<?php include 'includes/layout-end.php'; ?>
    <script>
        ...
        function setupEventListeners() {
            ...
            document.getElementById('issueDate').addEventListener('change', updateValidityDate);
        }
            ...
            return `
                <tr>
                    ...
                    <td class="actions-cell">
                        <button class="btn btn-sm btn-secondary" onclick="viewPermit(${permit.id})" title="View Details">👁️</button>
                        <button class="btn btn-sm btn-primary" onclick="editPermit(${permit.id})" title="Edit Permit">✏️</button>
                        <button class="btn btn-sm" style="background: #27ae60; color: white;" onclick="printPermit(${permit.id})" title="Print Permit">🖨️</button>
                        <button class="btn btn-sm" style="background: #ef4444; color: white;" onclick="deletePermit(${permit.id})" title="Delete Permit">🗑️</button>
                    </td>
                </tr>
            `;
        }
